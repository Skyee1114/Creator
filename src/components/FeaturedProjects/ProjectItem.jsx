...
const ProjectItem = ({featureTitle}) => {
        ...
        >
            <div className='absolute'>
                <div className="relative">
                    <img src={featureImages[featureTitle]} alt="feature" className="w-full h-full object-cover" />
            ...
            <div className='flex justify-end pt-4 pr-3'>
                <img src={Love} alt="love" className='w-10 h-10 transition-opacity duration-300 ease-in-out opacity-60 hover:opacity-100 z-10'/>
            </div>
