export function CreativityButton() {
    ...
    return (        
        <div className={`relative inline-flex items-center justify-start px-16 py-6 overflow-hidden font-medium transition-all bg-[#52f2a8] hover:bg-[#52f2a8] group`}>
            ...
            <span className={`relative w-full text-left text-[#174034] transition-colors duration-300 ease-in-out group-hover:text-[#1b1f2e] uppercase`}>pre-register now</span>
        </div>
    )
}
